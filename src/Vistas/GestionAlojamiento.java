 ...
 private final DefaultTableModel modelo = new DefaultTableModel(){
   ...
   public boolean isCellEditable(int fila, int colum){
    ...
    private void initComponents() {
        ...
        jTFPrecioMinimo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTFPrecioMinimoActionPerformed(evt);
            }
        });
        ...
        jBSeleccionar.setText("jButton1");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 922, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTFPrecioMinimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTFPrecioMinimoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTFPrecioMinimoActionPerformed

    private void jBBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscarActionPerformed
        //clic en el boton buscar, hace una consulta SQL en base al IDy llena los datos de la interfaz con la consulta
        //para poder editarlos mas facil.     
        int busq; //uso el id del textfield
         ...
         //si coloca un maximo (sin o con minimo)se CONSULTA BETWENN .
            ...
            try{
              ...
              {//Si no se aclaro precio maximo, es infinito.
                  ...
                  PreparedStatement statement = con.prepareStatement(SQLMIN);
              ...
              JOptionPane.showMessageDialog(rootPane, "Ingrese un valor minimo y/o maximo valido");           
...
private void updateAlojamiento(boolean estado){
   // el boton guardar y borrar llaman a este metodo para modificar el alojamiento    
    //llamo al metodo comprobarDatos, si son validos devuelve True y se ejecuta el update.
...
private boolean comprobarDatos(boolean id){
        ...
        if (jTTipo.getText().isEmpty()) {
            ...
            if (jTServicios.getText().isEmpty()) {
                ...
                for (char c : jTServicios.getText().toCharArray()) {
                    if (Character.isDigit(c)) {
                        retorno = false;
                        break;
                    }
...
private void insertarAlojamiento(){
     // crear nuevo Alojamiento
        ...
        try ( PreparedStatement statement = con.prepareStatement(sql)) {
           ...
           JOptionPane.showMessageDialog(rootPane, "Error en la conexion con la base de datos"); 
        } catch (ParseException ex) {
            Logger.getLogger(GestionAlojamiento.class.getName()).log(Level.SEVERE, null, ex);
        }        
        }
